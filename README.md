...
<tr><th rowspan="5">月时计</th><td rowspan="5">掌控时间的重要道具, 发动时空系技能的前提;<br>提供12格异空间储物栏, 内部时间流逝变慢, 物品腐坏速度降低(速度可设置), 面板关闭时内部与外界隔离, 可防生物嗅探;<br>装备时每分钟恢复6.8精神(可设置月岛降低启蒙)和20魔力</td></tr>
